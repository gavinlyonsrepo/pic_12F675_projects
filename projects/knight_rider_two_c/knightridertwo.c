/*
 * File:   knightridertwo.c
 * Function: PIC12F675 moving LED display.
 * Author: Gavin Lyons
 * URl: https://github.com/gavinlyonsrepo/pic_12F675_projects
 * Created on 10 January 2019, 15:53
 * IDE: MPLAB X v5.05
 * Compiler: xc8 v2.0
 */
...
void main(void) {
    ...
    char led_Array[14] = {0x01,0x02,0x04,0x08,0x10,0x20,0x40,0x80,0x40,0x20,0x10,0x08,0x04,0x02};
    unsigned int counter = 1;
   
    while(1){
                data = led_Array[counter];
                data_submit(data);
                 __delay_ms(500);
                counter++;
